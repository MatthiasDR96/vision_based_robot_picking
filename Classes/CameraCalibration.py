...
def calibrate_camera(objpoints, imgpoints):
    ...
    img = cv2.imread('./data/camera_calibration_images/CC_image_original_1.jpg')
    ...
    np.savez("./data/matrix_files/intrinsic_camera_properties.npz", data=camera_properties)
